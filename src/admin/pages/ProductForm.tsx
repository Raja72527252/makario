                ...
                <div className="px-8 py-6 max-h-[calc(100vh-300px)] overflow-y-auto">
                    ...
                    {activeTab === 'details' && (
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-900 mb-2">Number of Reviews</label>
                                <input
                                    type="number"
                                    min="0"
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-900 mb-2">Key Features & Benefits</label>
                                <div className="flex gap-2 mb-3">
                                    <input
                                        type="text"
                                        value={newFeature}
                    ...
                    {activeTab === 'nutrition' && (
                        <div className="space-y-6">
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                                <p className="text-sm text-blue-900">Add nutritional information per serving (optional)</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="block text-sm font-semibold text-gray-900 mb-2">Carbohydrates (g)</label>
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-900 mb-2">Fiber (g)</label>
                                <input
                                    type="text"
